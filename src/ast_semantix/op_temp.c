...
//                attrib = node->data->data;
//                op_closure_append(array_get_last(state->stack_memory)->data, node->data, attrib->data);
...
//            new_block->subtype = ((struct tk_token *) temp_array->data[i]->data)->subtype;
//            new_block->count = count;
//
//            if (((struct tk_token *) temp_array->data[i]->data)->subtype == Special_AND_AND ||
//                ((struct tk_token *) temp_array->data[i]->data)->subtype == Special_OR_OR ||
//                ((struct tk_token *) temp_array->data[i]->data)->subtype == Special_NOT)
//                is_bool = 1;
//
//        }
...
//                new_block->data1 = object_copy(object);
//
//                array_append(code_operations, temp_array->data[1]);
//                array_append(code_operations, temp_array->data[0]);
//                break;
//            }
...
//            case StmtType_array: {
//                {
//                    array_add_new(state->stack_memory, OP_CLOSURE_TYPE);
//
//                    array_add_new(code_operations, OP_BLOCK_TYPE);
//                    new_block = array_get_last(code_operations)->data;
...
////            }
//            struct op_closure *closure = array_get_last(state->stack_memory)->data;
...
////                        array_resize(state->temp_memory, block->count);
////                } else if (current_object->type == node_st_TYPE) {
////                    if (((struct node_st *) current_object->data)->type == StmtType_While) {
////                        break;
...
//                }
//                if (res != NULL && ok) {
//                    struct op_closure *temp_array = res->data;
//
//                    for (int i = 0; i < temp_array->size; i++) {
//                        attrib = temp_array->data[0][i]->data;
//                        op_closure_append(array_get_last(state->stack_memory)->data, temp_array->data[0][i], attrib->data);
...
////            array_add_new(state->memory, MAP_TYPE);
//            break;
//        }
//
//    }
...
//            array_remove_last(code_operations);
//
//            if (current_object->type == node_st_TYPE) {
