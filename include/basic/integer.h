...
// Convert Methods
void integer__bool(struct object_st *res, struct error_st *, struct integer_st *obj);
void integer__int(struct object_st *res, struct error_st *, struct integer_st *obj);
void integer__float(struct object_st *res, struct error_st *, struct integer_st *obj);
void integer__str(struct object_st *res, struct error_st *, struct integer_st *obj);
